...
from pokeme.views import (
    ...
    list_notes, create_category, update_category, delete_category,
    list_categories, update_profile, list_category_notes
)
...
routes = [
    ...
    Route('/categories/{category}/', 'DELETE', delete_category,
          'Delete-Category'),
    Route('/categories/{category}/', 'PUT', update_category,
          'Update-Category'),
    Route('/categories/{category}/notes/', 'GET', list_category_notes,
          'Category-Notes'),
